...
Text deltas are yielded immediately as they arrive.  Tool calls are buffered
internally and emitted as a single complete chunk — the caller never sees a
partial tool call.  The "done" chunk is always the last item yielded.
"""
